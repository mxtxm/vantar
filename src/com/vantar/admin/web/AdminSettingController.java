...
public class AdminSettingController extends RouteToMethod {
    ...
    public void systemSettingsReload(Params params, HttpServletResponse response) {
        AdminSettings.settingsReload(params, response);
    }

    public void systemSettingsEditConfig(Params params, HttpServletResponse response) {
        AdminSettings.settingsEdit(params, response, Settings.configClass);
    }

    public void systemSettingsEditTune(Params params, HttpServletResponse response) {
