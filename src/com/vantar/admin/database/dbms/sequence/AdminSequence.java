...
public class AdminSequence {
    ...
    public static void listMongoSequences(Params params, HttpServletResponse response) throws FinishException {
        WebUi ui = Admin.getUi(VantarKey.ADMIN_DATABASE_AUTOINCREMENT, params, response, true);
        ...
        ui  .addHeading(2, Db.Dbms.MONGO)
            .addHrefBlock(VantarKey.ADMIN_DATABASE_AUTOINCREMENT_CREATE, "/admin/data/list?dto=MongoSequence")
