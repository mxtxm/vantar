...
public class CommonModelElastic extends CommonModel {
    ...
    private static String updateMany(ElasticWrite write, List<Map<String, Object>> records, Dto dto, BatchEvent event) throws InputException, ServerException {
        for (Map<String, Object> record : records) {
    ...
    private static String deleteMany(ElasticWrite write, List<Long> ids, Dto dto, BatchEvent event) throws InputException, ServerException {
        for (Long id : ids) {
            dto.setId(id);
