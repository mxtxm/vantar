...
public class CommonModelSql extends CommonModel {
    ...
    private static ResponseMessage insertX(Object params, Dto dto, WriteEvent event) throws InputException, ServerException {
    ...
    public static <T extends Dto> ResponseMessage insertBatch(Params params, Class<T> tClass) throws InputException, ServerException {
        return insertBatch(params, tClass, null);
    }

    public static <T extends Dto> ResponseMessage insertBatch(Params params, Class<T> tClass, WriteEvent event) throws InputException, ServerException {
    ...
    public static <T extends Dto> ResponseMessage updateBatch(Params params, Class<T> tClass, WriteEvent event) throws InputException, ServerException {
        List<T> dtos = params.getJsonList(tClass);
        if (dtos == null || dtos.isEmpty()) {
            throw new InputException(VantarKey.INVALID_JSON_DATA);
        }
    ...
    public static <T extends Dto> ResponseMessage deleteBatch(Params params, Class<T> tClass, WriteEvent event) throws InputException, ServerException {
    ...
    private static String insertMany(CommonRepoSql repo, SqlExecute execute, List<Map<String, Object>> records, Dto dto, BatchEvent event) throws InputException, ServerException {
    ...
    private static String updateMany(CommonRepoSql repo, SqlExecute execute, List<Map<String, Object>> records, Dto dto, BatchEvent event) throws InputException, ServerException {
        for (Map<String, Object> record : records) {
    ...
    private static String deleteMany(SqlExecute execute, List<Long> ids, Dto dto, BatchEvent event) throws InputException, ServerException {
        for (Long id : ids) {
            dto.setId(id);
    ...
    public static ResponseMessage purge(String table) throws ServerException {
        try (SqlConnection connection = new SqlConnection()) {
            CommonRepoSql repo = new CommonRepoSql(connection);
            repo.purge(table);
            return ResponseMessage.success(VantarKey.DELETE_SUCCESS);
    ...
    public static ResponseMessage purgeData(String table) throws ServerException {
        try (SqlConnection connection = new SqlConnection()) {
            CommonRepoSql repo = new CommonRepoSql(connection);
